...
const bird1 = new Monster('Bird', 25, 12, './images/bird.svg',3,2);
const bird2 = new Monster('Bird', 25, 12, './images/bird.svg',6,2);
const bird3 = new Monster('Bird', 25, 12, './images/bird.svg',4,2);

const monstersArray = [bird1, bird2, bird3];
...
/** Your code goes here */
const arena = new Arena(monstersArray, heracles,10);
